...
export class RetornoComponent implements OnInit {
  ...
  private tipoPedido = 'R'; // N = Normal, B=Beneficiamento, R = Retorno, I = Intercompany
  ...
  newPedido() {
    this.router.navigateByUrl('/retorno/pedido/new');
  }

  editPedido(filial: string, numero: string, tipo: string) {
    this.router.navigateByUrl(`/retorno/pedido/edit/${filial}/${numero}/${tipo}`);
  }
  ...
  invoicePedido(filial: string, numero: string, tipo: string) {
    this.router.navigateByUrl(`/retorno/pedido/fat/${filial}/${numero}/${tipo}/S`);
  }

  classPedido(filial: string, numero: string, tipo: string) {
    this.router.navigateByUrl(`/retorno/pedido/class/${filial}/${numero}/${tipo}/N`);
  }
